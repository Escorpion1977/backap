...

{
    ...
    $manifest = file_get_contents('https://tecactus.github.io/backap/manifest.json');
    ...
    echo " - Downloading Backap v", Dumper::toString($item->version), "...$n";
    ...
    echo " - Making Backap executable...$n";

    @chmod($item->name, 0755);

    echo "{$n}Backap installed!$n";
